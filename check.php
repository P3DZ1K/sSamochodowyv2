...
$login = filter_var(trim($_POST['imie_klienta']), FILTER_SANITIZE_STRING);
$pass = filter_var(trim($_POST['haslo_klienta']), FILTER_SANITIZE_STRING);
$repeat_pass = filter_var(trim($_POST['repeat_pass']), FILTER_SANITIZE_STRING);
$city = filter_var(trim($_POST['miasto_klienta']), FILTER_SANITIZE_STRING);
$phone_number = filter_var(trim($_POST['telefon_klienta']), FILTER_SANITIZE_STRING);
$zdjecie = filter_var(trim($_POST['option']), FILTER_SANITIZE_STRING);
